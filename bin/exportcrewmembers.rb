...
# Class to export crew members from +FILE_INPUT+ to +FILE_OUTPUT+.
class CrewMemberExporter
...
#==============================================================================
  ...
  FILE_OUTPUT = File.expand_path(
    File.join(File.dirname(__FILE__), '../share/csv/crewmembers.csv')
  )
...
if __FILE__ == $0
  begin
    _ce = ALX::CrewMemberExporter.new
    _ce.exec
  rescue => _e
    print(_e.class, "\n", _e.message, "\n", _e.backtrace.join("\n"), "\n")
  end
