...
require_relative('../lib/alx/armordata.rb')
...
# Class to import armors from +FILE_INPUT+ to +FILE_OUTPUT+.
class ArmorImporter
...
#==============================================================================
  ...
  FILE_INPUT  = File.expand_path(
    File.join(File.dirname(__FILE__), '../share/csv/armors.csv')
  )
