...
#------------------------------------------------------------------------------
  ...
  _s.character_data_files = {
    'DC-EU-MK-51052' => _s.dr(_s.exec_file['DC'], 0x333a38...0x333dc8),
...
#------------------------------------------------------------------------------
  ...
  _s.exp_curve_data_files = {
    'DC-EU-MK-51052' => _s.dr(_s.level_file['DC'], 0x000...0x948),
    'DC-JP-HDR-0076' => _s.dr(_s.level_file['DC'], 0x000...0x948),
    'DC-US-MK-51052' => _s.dr(_s.level_file['DC'], 0x000...0x948),
    'GC-EU-GEA'      => _s.dr(_s.level_file['GC'], 0x000...0x948),
    'GC-JP-GEA'      => _s.dr(_s.level_file['GC'], 0x000...0x948),
    'GC-US-GEA'      => _s.dr(_s.level_file['GC'], 0x000...0x948),
  }
