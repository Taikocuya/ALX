...
#------------------------------------------------------------------------------
  ...
  # Path to BNR file relative to +SYS.root_dir+.
...
#------------------------------------------------------------------------------
  ...
  # Path to CSV file of accessories relative to +SYS.data_dir+.
  _s.accessory_csv_file            = "#{_s.data_dir}/accessory.csv"
  # Path to CSV file of armors relative to +SYS.data_dir+.
  _s.armor_csv_file                = "#{_s.data_dir}/armor.csv"
  # Path to CSV file of characters relative to +SYS.data_dir+.
  _s.character_csv_file            = "#{_s.data_dir}/character.csv"
  # Path to CSV file of character magics relative to +SYS.data_dir+.
  _s.character_magic_csv_file      = "#{_s.data_dir}/charactermagic.csv"
  # Path to CSV file of character super moves relative to +SYS.data_dir+.
  _s.character_super_move_csv_file = "#{_s.data_dir}/charactersupermove.csv"
  # Path to CSV file of crew members relative to +SYS.data_dir+.
  _s.crew_member_csv_file          = "#{_s.data_dir}/crewmember.csv"
  # Path to CSV file of defined strings relative to +SYS.data_dir+.
  _s.defined_string_csv_file       = "#{_s.data_dir}/definedstring.csv"
  # Path to CSV file of enemy database relative to +SYS.data_dir+.
  _s.enemy_csv_file                = "#{_s.data_dir}/enemy.csv"
  # Path to CSV file of enemy events relative to +SYS.data_dir+.
  _s.enemy_event_csv_file          = "#{_s.data_dir}/enemyevent.csv"
  # Path to CSV file of enemy encounters relative to +SYS.data_dir+.
  _s.enemy_encounter_csv_file      = "#{_s.data_dir}/enemyencounter.csv"
  # Path to CSV file of enemy magics relative to +SYS.data_dir+.
  _s.enemy_magic_csv_file          = "#{_s.data_dir}/enemymagic.csv"
  # Path to CSV file of enemy ships relative to +SYS.data_dir+.
  _s.enemy_ship_csv_file           = "#{_s.data_dir}/enemyship.csv"
  # Path to CSV file of enemy ship tasks relative to +SYS.data_dir+.
  _s.enemy_ship_task_csv_file      = "#{_s.data_dir}/enemyshiptask.csv"
  # Path to CSV file of enemy super moves relative to +SYS.data_dir+.
  ...
  # Path to CSV file of ship items relative to +SYS.data_dir+.
  _s.ship_item_csv_file            = "#{_s.data_dir}/shipitem.csv"
  # Path to CSV file of shops relative to +SYS.data_dir+.
  _s.shop_csv_file                 = "#{_s.data_dir}/shop.csv"
  # Path to CSV file of special items relative to +SYS.data_dir+.
...
#------------------------------------------------------------------------------
  ...
  # Path to TPL file of accessories relative to +SYS.build_dir+.
  _s.accessory_tpl_file            = 'accessory.tpl.csv'
  # Path to TPL file of armors relative to +SYS.build_dir+.
  _s.armor_tpl_file                = 'armor.tpl.csv'
  # Path to TPL file of characters relative to +SYS.build_dir+.
  _s.character_tpl_file            = 'character.tpl.csv'
  # Path to TPL file of character magics relative to +SYS.build_dir+.
  _s.character_magic_tpl_file      = 'charactermagic.tpl.csv'
  # Path to TPL file of character skills relative to +SYS.build_dir+.
  _s.character_super_move_tpl_file = 'charactersupermove.tpl.csv'
  # Path to TPL file of crew members relative to +SYS.build_dir+.
  _s.crew_member_tpl_file          = 'crewmember.tpl.csv'
  # Path to TPL file of enemy database relative to +SYS.build_dir+.
  _s.enemy_tpl_file                = 'enemy.tpl.csv'
  # Path to TPL file of enemy events relative to +SYS.build_dir+.
  _s.enemy_event_tpl_file          = 'enemyevent.tpl.csv'
  # Path to TPL file of enemy encounters relative to +SYS.build_dir+.
  _s.enemy_encounter_tpl_file      = 'enemyencounter.tpl.csv'
  # Path to TPL file of enemy magics relative to +SYS.build_dir+.
  _s.enemy_magic_tpl_file          = 'enemymagic.tpl.csv'
  # Path to TPL file of enemy ships relative to +SYS.build_dir+.
  _s.enemy_ship_tpl_file           = 'enemyship.tpl.csv'
  # Path to TPL file of enemy ship tasks relative to +SYS.build_dir+.
  _s.enemy_ship_task_tpl_file      = 'enemyshiptask.tpl.csv'
  # Path to TPL file of enemy skills relative to +SYS.build_dir+.
  ...
  # Path to TPL file of playable ships relative to +SYS.build_dir+.
  _s.playable_ship_tpl_file        = 'playableship.tpl.csv'
  # Path to TPL file of ship accessories relative to +SYS.build_dir+.
  _s.ship_accessory_tpl_file       = 'shipaccessory.tpl.csv'
  # Path to TPL file of ship cannons relative to +SYS.build_dir+.
  _s.ship_cannon_tpl_file          = 'shipcannon.tpl.csv'
  # Path to TPL file of ship items relative to +SYS.build_dir+.
  _s.ship_item_tpl_file            = 'shipitem.tpl.csv'
  # Path to TPL file of shops relative to +SYS.build_dir+.
  _s.shop_tpl_file                 = 'shop.tpl.csv'
  # Path to TPL file of special items relative to +SYS.build_dir+.
...
#------------------------------------------------------------------------------
  ...
  _s.accessory_data_files = {
    ...
    'DC-US-HDR-0000'          => rd(_s.exec_file['DC'], 0x2f02c4...0x2f0f44),
    'DC-US-IGN9'              => rd(_s.exec_file['DC'], 0x338c40...0x3398c0),
    'DC-US-MK-51052-20000905' => rd(_s.exec_file['DC'], 0x36c7ac...0x36d42c),
    'DC-US-MK-51052-20000914' => rd(_s.exec_file['DC'], 0x33e5f4...0x33f274),
    'DC-US-MK-51052-20001010' => rd(_s.exec_file['DC'], 0x33e6f0...0x33f370),
  ...
  _s.accessory_dscr_files = {
    ...
    'DC-US-HDR-0000'                    => rd(
      _s.exec_file['DC'], 0x2ead78...0x2eb0ec, excl: [
        0xa1, 0xa3..0xa7, 0xa9..0xaf, 0xb1..0xb5, 0xb8..0xbf, 0xc1..0xc8, 
        0xcb, 0xce, 0xd0, 0xd2, 0xd3
      ]
    ),
    ...
    'DC-US-MK-51052-20000905'           => rd(
      _s.exec_file['DC'], 0x364228...0x3653bc
    ),
    'DC-US-MK-51052-20000914'           => rd(
      _s.exec_file['DC'], 0x3353f0...0x336850
    ),
...
#------------------------------------------------------------------------------
  ...
  _s.armor_data_files = {
    ...
    'DC-US-HDR-0000'          => rd(_s.exec_file['DC'], 0x2ef644...0x2f02c4),
    'DC-US-IGN9'              => rd(_s.exec_file['DC'], 0x337fc0...0x338c40),
    'DC-US-MK-51052-20000905' => rd(_s.exec_file['DC'], 0x36bb2c...0x36c7ac),
    'DC-US-MK-51052-20000914' => rd(_s.exec_file['DC'], 0x33d974...0x33e5f4),
    'DC-US-MK-51052-20001010' => rd(_s.exec_file['DC'], 0x33da70...0x33e6f0),
  ...
  _s.armor_dscr_files = {
    ...
    'DC-US-HDR-0000'                    => rd(
      _s.exec_file['DC'], 0x2eab28...0x2ead78, excl: [0x59, 0x5b..0x70]
    ),
    'DC-US-IGN9'                        => rd(
      _s.exec_file['DC'], 0x33337c...0x33356c, excl: [0x59, 0x5b..0x70]
    ),
    'DC-US-MK-51052-20000905'           => rd(
      _s.exec_file['DC'], 0x363334...0x364228
    ),
    'DC-US-MK-51052-20000914'           => rd(
      _s.exec_file['DC'], 0x3342a0...0x3353f0
    ),
    'DC-US-MK-51052-20001010'           => rd(
...
#------------------------------------------------------------------------------
  ...
  _s.character_data_files = {
    ...
    'DC-US-HDR-0000'          => rd(_s.exec_file['DC'], 0x2edd14...0x2ee0a4),
    'DC-US-IGN9'              => rd(_s.exec_file['DC'], 0x336690...0x336a20),
    'DC-US-MK-51052-20000905' => rd(_s.exec_file['DC'], 0x36a1fc...0x36a58c),
    'DC-US-MK-51052-20000914' => rd(_s.exec_file['DC'], 0x33c044...0x33c3d4),
    'DC-US-MK-51052-20001010' => rd(_s.exec_file['DC'], 0x33c140...0x33c4d0),
...
#------------------------------------------------------------------------------
  ...
  _s.character_magic_data_files = {
    ...
    'DC-US-HDR-0000'          => rd(_s.exec_file['DC'], 0x2ee0a4...0x2ee764),
    'DC-US-IGN9'              => rd(_s.exec_file['DC'], 0x336a20...0x3370e0),
    'DC-US-MK-51052-20000905' => rd(_s.exec_file['DC'], 0x36a58c...0x36ac4c),
    'DC-US-MK-51052-20000914' => rd(_s.exec_file['DC'], 0x33c3d4...0x33ca94),
    'DC-US-MK-51052-20001010' => rd(_s.exec_file['DC'], 0x33c4d0...0x33cb90),
  ...
  _s.character_magic_dscr_files = {
    ...
    'DC-US-HDR-0000'                    => rd(
      _s.exec_file['DC'], 0x2e9848...0x2ea25c
    ),
    'DC-US-IGN9'                        => rd(
      _s.exec_file['DC'], 0x3320b4...0x332ab8
    ),
    'DC-US-MK-51052-20000905'           => rd(
      _s.exec_file['DC'], 0x36076c...0x361424
    ),
    'DC-US-MK-51052-20000914'           => rd(
      _s.exec_file['DC'], 0x3312b8...0x332028
    ),
    'DC-US-MK-51052-20001010'           => rd(
  ...
  _s.character_magic_ship_dscr_files = {
    ...
    'DC-US-HDR-0000'                    => rd(
      _s.exec_file['DC'], 0x2ed4ec...0x2edca0, excl: [0xa..0xc, 0xe..0x13     ]
    ),
    'DC-US-IGN9'                        => rd(
      _s.exec_file['DC'], 0x335c10...0x3363c4, excl: [0xa..0xc, 0xe..0x13     ]
    ),
    'DC-US-MK-51052-20000905'           => rd(
      _s.exec_file['DC'], 0x3692e4...0x369bcc, excl: [0x8, 0xa..0xc, 0xe..0x13]
    ),
    'DC-US-MK-51052-20000914'           => rd(
      _s.exec_file['DC'], 0x33aff0...0x33b920, excl: [0x8, 0xa..0xc, 0xe..0x13]
    ),
    'DC-US-MK-51052-20001010'           => rd(
...
#------------------------------------------------------------------------------
  ...
  _s.character_super_move_data_files = {
    ...
    'DC-US-HDR-0000'          => rd(_s.exec_file['DC'], 0x2ee764...0x2eec44),
    'DC-US-IGN9'              => rd(_s.exec_file['DC'], 0x3370e0...0x3375c0),
    'DC-US-MK-51052-20000905' => rd(_s.exec_file['DC'], 0x36ac4c...0x36b12c),
    'DC-US-MK-51052-20000914' => rd(_s.exec_file['DC'], 0x33ca94...0x33cf74),
    'DC-US-MK-51052-20001010' => rd(_s.exec_file['DC'], 0x33cb90...0x33d070),
  ...
  _s.character_super_move_dscr_files = {
    ...
    'DC-US-HDR-0000'                    => rd(
      _s.exec_file['DC'], 0x2ea25c...0x2ea848
    ),
    'DC-US-IGN9'                        => rd(
      _s.exec_file['DC'], 0x332ab8...0x333110, excl: [0x31]
    ),
    'DC-US-MK-51052-20000905'           => rd(
      _s.exec_file['DC'], 0x361424...0x361d60
    ),
    'DC-US-MK-51052-20000914'           => rd(
      _s.exec_file['DC'], 0x332028...0x3329d4
    ),
    'DC-US-MK-51052-20001010'           => rd(
...
#------------------------------------------------------------------------------
  ...
  _s.crew_member_data_files = {
    ...
    'DC-US-HDR-0000'          => rd(_s.exec_file['DC'], 0x2f5180...0x2f5440),
    'DC-US-IGN9'              => rd(_s.exec_file['DC'], 0x33dc64...0x33df7c),
    'DC-US-MK-51052-20000905' => rd(_s.exec_file['DC'], 0x3717d0...0x371ae8),
    'DC-US-MK-51052-20000914' => rd(_s.exec_file['DC'], 0x343618...0x343930),
    'DC-US-MK-51052-20001010' => rd(_s.exec_file['DC'], 0x343714...0x343a2c),
  ...
  _s.crew_member_dscr_files = {
    ...
    'DC-US-HDR-0000'                    => rd(
      _s.exec_file['DC'], 0x2edca0...0x2edd14, excl: [
    ...
    'DC-US-MK-51052-20000905'           => rd(
      _s.exec_file['DC'], 0x369bcc...0x36a1fc
    ),
    'DC-US-MK-51052-20000914'           => rd(
      _s.exec_file['DC'], 0x33b920...0x33c044
    ),
    'DC-US-MK-51052-20001010'           => rd(
...
#------------------------------------------------------------------------------
  ...
  _s.defined_string_data_files = {
    ...
    'DC-US-HDR-0000'          => rd(_s.exec_file['DC'], [
    ...
    'DC-US-MK-51052-20000905' => rd(_s.exec_file['DC'], [
      0x000030...0x000041, 0x00577c...0x0057a8, 0x005d88...0x005d8d,
    ...
    'DC-US-MK-51052-20000914' => rd(_s.exec_file['DC'], [
      0x000030...0x000041, 0x00577c...0x0057a8, 0x005d88...0x005d8d, 
    ...
    'DC-US-MK-51052-20001010' => rd(_s.exec_file['DC'], [
      0x000030...0x000041, 0x00577c...0x0057a8, 0x005d88...0x005d8d,
...
#------------------------------------------------------------------------------
  ...
  _s.enemy_event_bgm_files = {
    ...
    'DC-US-MK-51052-20001010' => rd(_s.exec_file['DC'], 0x3f4eb8...0x3f4ef3),
...
#------------------------------------------------------------------------------
  ...
  _s.enemy_magic_data_files = {
    ...
    'DC-US-HDR-0000'          => rd(_s.exec_file['DC'], 0x303540...0x303a50),
    'DC-US-IGN9'              => rd(_s.exec_file['DC'], 0x350fe4...0x3514f4),
    'DC-US-MK-51052-20000905' => rd(_s.exec_file['DC'], 0x385db0...0x3862c0),
    'DC-US-MK-51052-20000914' => rd(_s.exec_file['DC'], 0x356bc4...0x3570d4),
    'DC-US-MK-51052-20001010' => rd(_s.exec_file['DC'], 0x356c30...0x357140),
...
#------------------------------------------------------------------------------
  ...
  _s.enemy_ship_data_files = {
    ...
    'DC-US-HDR-0000'          => rd(_s.exec_file['DC'], 0x2f2c00...0x2f3fb0),
    'DC-US-IGN9'              => rd(_s.exec_file['DC'], 0x33b57c...0x33ca94),
    'DC-US-MK-51052-20000905' => rd(_s.exec_file['DC'], 0x36f0e8...0x370600),
    'DC-US-MK-51052-20000914' => rd(_s.exec_file['DC'], 0x340f30...0x342448),
    'DC-US-MK-51052-20001010' => rd(_s.exec_file['DC'], 0x34102c...0x342544),
...
#------------------------------------------------------------------------------
  ...
  _s.enemy_super_move_data_files = {
    ...
    'DC-US-HDR-0000'          => rd(_s.exec_file['DC'], 0x303a50...0x306090),
    'DC-US-IGN9'              => rd(_s.exec_file['DC'], 0x3514f4...0x353b34),
    'DC-US-MK-51052-20000905' => rd(_s.exec_file['DC'], 0x3862c0...0x388900),
    'DC-US-MK-51052-20000914' => rd(_s.exec_file['DC'], 0x3570d4...0x359714),
    'DC-US-MK-51052-20001010' => rd(_s.exec_file['DC'], 0x357140...0x359780),
...
#------------------------------------------------------------------------------
  ...
  _s.playable_ship_data_files = {
    ...
    'DC-US-HDR-0000'          => rd(_s.exec_file['DC'], 0x2f2a0c...0x2f2c00),
    'DC-US-IGN9'              => rd(_s.exec_file['DC'], 0x33b388...0x33b57c),
    'DC-US-MK-51052-20000905' => rd(_s.exec_file['DC'], 0x36eef4...0x36f0e8),
    'DC-US-MK-51052-20000914' => rd(_s.exec_file['DC'], 0x340d3c...0x340f30),
    'DC-US-MK-51052-20001010' => rd(_s.exec_file['DC'], 0x340e38...0x34102c),
...
#------------------------------------------------------------------------------
  ...
  _s.ship_accessory_data_files = {
    ...
    'DC-US-HDR-0000'          => rd(_s.exec_file['DC'], 0x2f45f0...0x2f4cd0),
    'DC-US-IGN9'              => rd(_s.exec_file['DC'], 0x33d0d4...0x33d7b4),
    'DC-US-MK-51052-20000905' => rd(_s.exec_file['DC'], 0x370c40...0x371320),
    'DC-US-MK-51052-20000914' => rd(_s.exec_file['DC'], 0x342a88...0x343168),
    'DC-US-MK-51052-20001010' => rd(_s.exec_file['DC'], 0x342b84...0x343264),
  ...
  _s.ship_accessory_dscr_files = {
    ...
    'DC-US-HDR-0000'                    => rd(
      _s.exec_file['DC'], 0x2ec5b8...0x2ece84
    ),
    'DC-US-IGN9'                        => rd(
      _s.exec_file['DC'], 0x334cdc...0x3355a8
    ),
    'DC-US-MK-51052-20000905'           => rd(
      _s.exec_file['DC'], 0x367eb0...0x368a08
    ),
    'DC-US-MK-51052-20000914'           => rd(
      _s.exec_file['DC'], 0x33990c...0x33a61c
    ),
    'DC-US-MK-51052-20001010'           => rd(
...
#------------------------------------------------------------------------------
  ...
  _s.ship_cannon_data_files = {
    ...
    'DC-US-HDR-0000'          => rd(_s.exec_file['DC'], 0x2f3fb0...0x2f45f0),
    'DC-US-IGN9'              => rd(_s.exec_file['DC'], 0x33ca94...0x33d0d4),
    'DC-US-MK-51052-20000905' => rd(_s.exec_file['DC'], 0x370600...0x370c40),
    'DC-US-MK-51052-20000914' => rd(_s.exec_file['DC'], 0x342448...0x342a88),
    'DC-US-MK-51052-20001010' => rd(_s.exec_file['DC'], 0x342544...0x342b84),
  ...
  _s.ship_cannon_dscr_files = {
    ...
    'DC-US-HDR-0000'                    => rd(
      _s.exec_file['DC'], 0x2ebc1c...0x2ec5b8
    ),
    'DC-US-IGN9'                        => rd(
      _s.exec_file['DC'], 0x334340...0x334cdc
    ),
    'DC-US-MK-51052-20000905'           => rd(
      _s.exec_file['DC'], 0x367388...0x367eb0
    ),
    'DC-US-MK-51052-20000914'           => rd(
      _s.exec_file['DC'], 0x338c38...0x33990c
    ),
    'DC-US-MK-51052-20001010'           => rd(
...
#------------------------------------------------------------------------------
  ...
  _s.ship_item_data_files = {
    ...
    'DC-US-HDR-0000'          => rd(_s.exec_file['DC'], 0x2f4cd0...0x2f5180),
    'DC-US-IGN9'              => rd(_s.exec_file['DC'], 0x33d7b4...0x33dc64),
    'DC-US-MK-51052-20000905' => rd(_s.exec_file['DC'], 0x371320...0x3717d0),
    'DC-US-MK-51052-20000914' => rd(_s.exec_file['DC'], 0x343168...0x343618),
    'DC-US-MK-51052-20001010' => rd(_s.exec_file['DC'], 0x343264...0x343714),
  ...
  _s.ship_item_dscr_files = {
    ...
    'DC-US-HDR-0000'                    => rd(
      _s.exec_file['DC'], 0x2ece84...0x2edca0
    ),
    'DC-US-IGN9'                        => rd(
      _s.exec_file['DC'], 0x3355a8...0x335c10
    ),
    'DC-US-MK-51052-20000905'           => rd(
      _s.exec_file['DC'], 0x368a08...0x3692e4
    ),
    'DC-US-MK-51052-20000914'           => rd(
      _s.exec_file['DC'], 0x33a61c...0x33aff0
    ),
    'DC-US-MK-51052-20001010'           => rd(
...
#------------------------------------------------------------------------------
  ...
  _s.shop_data_files = {
    ...
    'DC-US-HDR-0000'          => rd(_s.exec_file['DC'], 0x409df8...0x409f30),
    'DC-US-IGN9'              => rd(_s.exec_file['DC'], 0x3f8808...0x3f8940),
    'DC-US-MK-51052-20000905' => rd(_s.exec_file['DC'], 0x4594f8...0x45a670),
    'DC-US-MK-51052-20000914' => rd(_s.exec_file['DC'], 0x3fe50c...0x3ff684),
    'DC-US-MK-51052-20001010' => rd(_s.exec_file['DC'], 0x3fe558...0x3ff6d0),
  ...
  _s.shop_dscr_files = {
    ...
    'DC-US-HDR-0000'                    => rd(
      _s.exec_file['DC'], 0x2fc450...0x2fc488, msgt: true
    ),
    'DC-US-IGN9'                        => rd(
...
#------------------------------------------------------------------------------
  ...
  _s.special_item_data_files = {
    ...
    'DC-US-HDR-0000'          => rd(_s.exec_file['DC'], 0x2f1c28...0x2f2308),
    'DC-US-IGN9'              => rd(_s.exec_file['DC'], 0x33a5a4...0x33ac84),
    'DC-US-MK-51052-20000905' => rd(_s.exec_file['DC'], 0x36e110...0x36e7f0),
    'DC-US-MK-51052-20000914' => rd(_s.exec_file['DC'], 0x33ff58...0x340638),
    'DC-US-MK-51052-20001010' => rd(_s.exec_file['DC'], 0x340054...0x340734),
  ...
  _s.special_item_dscr_files = {
    ...
    'DC-US-HDR-0000'                    => rd(
      _s.exec_file['DC'], 0x2eb8bc...0x2ebc1c, excl: [
        0x14a, 0x14b, 0x151, 0x154
      ]
    ),
    'DC-US-IGN9'                        => rd(
    ...
    'DC-US-MK-51052-20000905'           => rd(
      _s.exec_file['DC'], 0x3668e8...0x367388, excl: [
        0x152, 0x15b, 0x161..0x162
      ]
    ),
    'DC-US-MK-51052-20000914'           => rd(
      _s.exec_file['DC'], 0x338078...0x338c38, excl: [
        0x152, 0x15b, 0x161..0x162
      ]
    ),
    'DC-US-MK-51052-20001010'           => rd(
...
#------------------------------------------------------------------------------
  ...
  _s.spirit_curve_data_files = {
    ...
    'DC-US-HDR-0000'          => rd(_s.exec_file['DC'], 0x2f2528...0x2f29cc),
    'DC-US-IGN9'              => rd(_s.exec_file['DC'], 0x33aea4...0x33b348),
    'DC-US-MK-51052-20000905' => rd(_s.exec_file['DC'], 0x36ea10...0x36eeb4),
    'DC-US-MK-51052-20000914' => rd(_s.exec_file['DC'], 0x340858...0x340cfc),
    'DC-US-MK-51052-20001010' => rd(_s.exec_file['DC'], 0x340954...0x340df8),
...
#------------------------------------------------------------------------------
  ...
  _s.swashbuckler_data_files = {
    ...
    'DC-US-HDR-0000'          => rd(_s.exec_file['DC'], 0x2f2308...0x2f2528),
    'DC-US-IGN9'              => rd(_s.exec_file['DC'], 0x33ac84...0x33aea4),
    'DC-US-MK-51052-20000905' => rd(_s.exec_file['DC'], 0x36e7f0...0x36ea10),
    'DC-US-MK-51052-20000914' => rd(_s.exec_file['DC'], 0x340638...0x340858),
    'DC-US-MK-51052-20001010' => rd(_s.exec_file['DC'], 0x340734...0x340954),
...
#------------------------------------------------------------------------------
  ...
  _s.treasure_chest_data_files = {
    ...
    'DC-US-HDR-0000'          => rd(_s.exec_file['DC'], 0x2e8238...0x2e8268),
    'DC-US-IGN9'              => rd(_s.exec_file['DC'], 0x330148...0x330500),
    'DC-US-MK-51052-20000905' => rd(_s.exec_file['DC'], 0x35d1a0...0x35d558),
    'DC-US-MK-51052-20000914' => rd(_s.exec_file['DC'], 0x32f298...0x32f650),
    'DC-US-MK-51052-20001010' => rd(_s.exec_file['DC'], 0x32f3b0...0x32f768),
...
#------------------------------------------------------------------------------
  ...
  _s.usable_item_data_files = {
    ...
    'DC-US-HDR-0000'          => rd(_s.exec_file['DC'], 0x2f10e8...0x2f1c28),
    'DC-US-IGN9'              => rd(_s.exec_file['DC'], 0x339a64...0x33a5a4),
    'DC-US-MK-51052-20000905' => rd(_s.exec_file['DC'], 0x36d5d0...0x36e110),
    'DC-US-MK-51052-20000914' => rd(_s.exec_file['DC'], 0x33f418...0x33ff58),
    'DC-US-MK-51052-20001010' => rd(_s.exec_file['DC'], 0x33f514...0x340054),
  ...
  _s.usable_item_dscr_files = {
    ...
    'DC-US-HDR-0000'                    => rd(
      _s.exec_file['DC'], 0x2eb0ec...0x2eb8bc, excl: [
        0x100..0x101, 0x10c..0x11a
      ]
    ),
    'DC-US-IGN9'                        => rd(
    ...
    'DC-US-MK-51052-20000905'           => rd(
      _s.exec_file['DC'], 0x3653bc...0x3668e8, excl: [
        0x0f2, 0x10c, 0x12d..0x130
      ]
    ),
    'DC-US-MK-51052-20000914'           => rd(
      _s.exec_file['DC'], 0x336850...0x338078, excl: [
        0x12d..0x130
      ]
    ),
    'DC-US-MK-51052-20001010'           => rd(
...
#------------------------------------------------------------------------------
  ...
  _s.weapon_data_files = {
    ...
    'DC-US-HDR-0000'          => rd(_s.exec_file['DC'], 0x2eec44...0x2ef644),
    'DC-US-IGN9'              => rd(_s.exec_file['DC'], 0x3375c0...0x337fc0),
    'DC-US-MK-51052-20000905' => rd(_s.exec_file['DC'], 0x36b12c...0x36bb2c),
    'DC-US-MK-51052-20000914' => rd(_s.exec_file['DC'], 0x33cf74...0x33d974),
    'DC-US-MK-51052-20001010' => rd(_s.exec_file['DC'], 0x33d070...0x33da70),
  ...
  _s.weapon_dscr_files = {
    ...
    'DC-US-HDR-0000'                    => rd(
      _s.exec_file['DC'], 0x2ea848...0x2eab28, excl: [
        0x03..0x04, 0x06..0x0f, 0x12..0x13, 0x15..0x1f, 0x22..0x2f, 0x31..0x39, 
        0x3b..0x3f, 0x41..0x46
      ]
    ),
    ...
    'DC-US-MK-51052-20000905'           => rd(
      _s.exec_file['DC'], 0x361d60...0x363334
    ),
    'DC-US-MK-51052-20000914'           => rd(
      _s.exec_file['DC'], 0x3329d4...0x3342a0
    ),
    'DC-US-MK-51052-20001010'           => rd(
...
#------------------------------------------------------------------------------
  ...
  _s.weapon_effect_data_files = {
    ...
    'DC-US-HDR-0000'          => rd(_s.exec_file['DC'], 0x2f0f44...0x2f10e8),
    'DC-US-IGN9'              => rd(_s.exec_file['DC'], 0x3398c0...0x339a64),
    'DC-US-MK-51052-20000905' => rd(_s.exec_file['DC'], 0x36d42c...0x36d5d0),
    'DC-US-MK-51052-20000914' => rd(_s.exec_file['DC'], 0x33f274...0x33f418),
    'DC-US-MK-51052-20001010' => rd(_s.exec_file['DC'], 0x33f370...0x33f514),
