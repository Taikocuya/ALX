...
#==============================================================================
  ...
  def init_props
    ...
    self[VOC.maxmp_growth] = FltProp.new(:f32, 0.0, prec: 2)
    ...
    self[padding_hdr        ] = IntProp.new(:i16,   0         )
    self[VOC.power_growth   ] = FltProp.new(:f32, 0.0, prec: 2)
    self[VOC.will_growth    ] = FltProp.new(:f32, 0.0, prec: 2)
    self[VOC.vigor_growth   ] = FltProp.new(:f32, 0.0, prec: 2)
    self[VOC.agile_growth   ] = FltProp.new(:f32, 0.0, prec: 2)
    self[VOC.quick_growth   ] = FltProp.new(:f32, 0.0, prec: 2)
