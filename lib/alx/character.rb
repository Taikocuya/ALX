...
#==============================================================================
  ...
  def initialize(_root)
    ...
    members << IntVar.new(padding_hdr               ,  0, :int8  )
    members << IntVar.new(VOC.weapon_id             ,  0, :uint8 )
    ...
    members << IntVar.new(padding_hdr               ,  0, :int16 )
    members << IntVar.new(VOC.green_exp[-1]         ,  0, :int16 )
    members << IntVar.new(padding_hdr               ,  0, :int16 )
    members << IntVar.new(VOC.red_exp[-1]           ,  0, :int16 )
    members << IntVar.new(padding_hdr               ,  0, :int16 )
    members << IntVar.new(VOC.purple_exp[-1]        ,  0, :int16 )
    members << IntVar.new(padding_hdr               ,  0, :int16 )
    members << IntVar.new(VOC.blue_exp[-1]          ,  0, :int16 )
    members << IntVar.new(padding_hdr               ,  0, :int16 )
    members << IntVar.new(VOC.yellow_exp[-1]        ,  0, :int16 )
    members << IntVar.new(padding_hdr               ,  0, :int16 )
    members << IntVar.new(VOC.silver_exp[-1]        ,  0, :int16 )
  end
