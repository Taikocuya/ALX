...
#==============================================================================
  ...
  SCOPES.store( 96, 'Ally area #1'          )
  SCOPES.store( 97, 'Ally area #2'          )
  SCOPES.store( 98, 'Ally area #3'          )
  SCOPES.store(100, 'Ally line #1'          )
  SCOPES.store(101, 'Ally line #2'          )
  SCOPES.store(102, 'Ally line #3'          )
  SCOPES.store(103, 'Ally line #4'          )
  SCOPES.store(107, 'Ally line #5'          )
  SCOPES.store(200, 'Allies nearby #1'      )
  SCOPES.store(201, 'Allies nearby #2'      )
