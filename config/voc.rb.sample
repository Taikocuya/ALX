...
#------------------------------------------------------------------------------
  ...
  _v.ship_dscr_opt  = hdr('[Ship %s Descr Str]' )
  _v.sot_pos        = hdr('%s SOT Pos')
...
#------------------------------------------------------------------------------
  ...
  _v.enemies = {
    ...
    'DC-US-HDR-0000-0'   => 'Battleship Soldier',
    'DC-US-HDR-0000-1'   => 'Sailor',
    'DC-US-HDR-0000-2'   => 'Micrastel',
    'DC-US-HDR-0000-7'   => 'Magic Executor',
    'DC-US-HDR-0000-15'  => 'Nur',
    'DC-US-HDR-0000-29'  => 'Elmo',
    'DC-US-HDR-0000-72'  => 'Guard',
    'DC-US-HDR-0000-96'  => 'Stonehawk',
    'DC-US-HDR-0000-99'  => 'Kantor',
    'DC-US-HDR-0000-129' => 'Agathamaus',
    'DC-US-HDR-0000-130' => 'Imagotalia',
    'DC-US-HDR-0000-131' => 'Warden',
    'DC-US-HDR-0000-133' => 'Escort Officer',
    'DC-US-HDR-0000-134' => 'Laas',
...
#------------------------------------------------------------------------------
  ...
  _v.treasure_chests = {
    ...
    'DC-US-HDR-0000-5'   => 'Pirate Isle Underground',
